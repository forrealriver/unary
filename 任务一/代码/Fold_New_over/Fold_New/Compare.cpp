...
void Compare::Warning(int warning, CString findflie) 
{
	switch (warning) 
	{
	case 1:AfxMessageBox(_T("“" + findflie + "”文件夹不存在！"));
		break;
	case 2:AfxMessageBox(_T("“" + findflie + "” 中存在格式不正确的子文件夹（没有8位字符）,请及时修改！"));
		break;
	case 3:AfxMessageBox(_T("“" + findflie + "” 中存在格式不正确的子文件夹（前8位不全是数字）,请及时修改！")); 
		break;
	case 4:AfxMessageBox(_T("“" + findflie + "” 中全部的子文件夹格式都不正确,请及时修改！")); 
		break;
	}
}